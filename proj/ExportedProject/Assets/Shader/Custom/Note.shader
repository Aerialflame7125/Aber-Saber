...
Shader "Urki/Note"
{
	Properties
	{
		...
		[Toggle]_UseGlowEdge("Use Glow Edge", Float) = 0
		[Toggle]_EnablePlaneCut("Enable PlaneCut", Float) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( ( ( ( _CustomFogColorMultiplier * _CustomFogColor ) + tex2D( _BloomPrePassTexture, localMyCustomExpression133 ) ) * clampResult84 ) + ( temp_output_61_0 * ( switchResult159 + ( staticSwitch162 * staticSwitch144 ) + ( float4( (( _UseGlowEdge )?( localMyCustomExpression122 ):( temp_cast_5 )) , 0.0 ) * staticSwitch162 ) ) ) ).xyz;
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;192.917;876.3128;1;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-688.3022,405.019;Inherit;False;Property;_CutoutTexScale;Cutout Texture Scale;10;0;Create;False;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;146;408.0649,247.5331;Inherit;False;Property;_CutPlane;_CutPlane;18;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;124;-156.8693,528.3835;Inherit;False;Property;_SliceEdge;Slice Edge;17;0;Create;True;0;0;0;False;0;False;0;-0.03;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;161;658.0042,472.6026;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;177;-195.917,323.1872;Inherit;True;Global;_CutoutTex;_CutoutTex;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;LockedToTexture3D;False;Object;-1;Auto;Texture3D;8;0;SAMPLER3D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;2;-60,-62.5;Inherit;False;Property;_CullMode;Cull Mode;6;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;112;461.1307,577.3835;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;111;473.1307,423.3835;Half;False;Property;_SlicePos;_SlicePos;13;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-173.541,247.0483;Inherit;False;Property;_Cutout;Cutout;9;1;[Header];Create;True;1;Cutout and Debris;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;113;629.1307,717.3835;Half;False;Property;_TransformOffset;_TransformOffset;14;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;17;-135.541,-309.9517;Inherit;False;Property;_ColorIntensity;Color Intensity;1;0;Create;True;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;13;-134,-232.5;Inherit;False;Property;_Color;Color;0;1;[Header];Create;True;1;Color and Fog;0;0;False;0;False;0,0,0,0;0.245283,0.245283,0.245283,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-159.7152,-407.1762;Inherit;False;Property;_FogScale;Fog Scale;3;0;Create;True;0;0;0;False;0;False;0;0.54;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;184;1128.083,407.1872;Inherit;False;Property;_UseGlowEdge;Use Glow Edge;15;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.NegateNode;164;167.6978,362.019;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;51;254.2534,249.8194;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.05;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;183;1140.083,209.1872;Inherit;False;Property;_EnablePlaneCut;Enable PlaneCut;16;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;181;392.7571,-758.8277;Inherit;False;Global;_CustomFogGammaCorrection;_CustomFogGammaCorrection;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;119;1521.877,150.1012;Inherit;False;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=CBBC732F5282E346B21608758B156CFF85C5709D