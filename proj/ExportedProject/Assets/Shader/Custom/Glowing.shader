...
Shader "Urki/Glowing"
{
	...
	SubShader
	{
		...
		float2 MyCustomExpression32( float2 input )
		{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 input32 = ase_grabScreenPosNorm.xy;
			float2 localMyCustomExpression32 = MyCustomExpression32( input32 );
			o.Emission = ( ( staticSwitch36 * temp_output_12_0 ) + ( clampResult24 * ( tex2D( _BloomPrePassTexture, localMyCustomExpression32 ) + ( _CustomFogColor * _CustomFogColorMultiplier ) ) ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;1349.966;517.8689;1;False;False
Node;AmplifyShaderEditor.RangedFloatNode;25;-1048.188,-120.5553;Inherit;False;Global;_CustomFogOffset;_CustomFogOffset;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1033.188,-261.5553;Inherit;False;Global;_CustomFogAttenuation;_CustomFogAttenuation;7;0;Create;True;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;27;-531.058,192.1339;Inherit;False;Global;_CustomFogColor;_CustomFogColor;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CustomExpressionNode;32;-669.9659,28.6311;Inherit;False;#ifdef UNITY_UV_STARTS_AT_TOP${$}$#else${$	input.y = 1 - input.y@$}$#endif$return input@;2;Create;1;True;input;FLOAT2;0,0;In;;Inherit;False;My Custom Expression;True;False;0;;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;274,-97.5;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;13;567,-156.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=0CED9200CD9AC0A01288D9F181258EA924517F9E