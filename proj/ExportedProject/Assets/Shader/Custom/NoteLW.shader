...
Shader "Urki/NoteLW"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#else
				float3 staticSwitch123 = temp_cast_3;
			#endif
			o.Emission = ( ( ( ( _CustomFogColorMultiplier * _CustomFogColor ) + tex2D( _BloomPrePassTexture, localMyCustomExpression133 ) ) * clampResult84 ) + ( temp_output_61_0 * ( switchResult159 + ( staticSwitch162 * 0.0 ) + ( float4( staticSwitch123 , 0.0 ) * staticSwitch162 ) ) ) ).xyz;
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;429.4419;1036.602;1;False;False
...
Node;AmplifyShaderEditor.Vector4Node;146;408.0649,247.5331;Inherit;False;Property;_CutPlane;_CutPlane;18;0;Create;True;0;0;0;False;0;False;0,0,0,0;-1.04,0,0,0.21;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-135.541,-309.9517;Inherit;False;Property;_ColorIntensity;Color Intensity;1;0;Create;True;0;0;0;False;0;False;0;11.69;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;123;1081.131,430.3835;Inherit;False;Property;_UseGlowEdge;Use Glow Edge;16;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;11;626,61.5;Inherit;False;Constant;_Glow;Glow;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;125;1348.131,400.3835;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;119;1519.877,150.1012;Inherit;False;2;0;INT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-688.3022,405.019;Inherit;False;Property;_CutoutTexScale;Cutout Texture Scale;10;0;Create;False;0;0;0;False;0;False;0;0.25;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=69072AF9451860ABFED1F5AF02113210A278750C