...
Shader "Urki/Smoke"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Alpha = ( i.vertexColor.a * tex2D( _MainTex, uv_MainTex ).r * _SmokeIntensity * ( 1.0 - ( ( _ZBufferParams.z * ( ( tex2D( _CameraDepthTexture, ase_grabScreenPosNorm.xy ).r * _Offsets.x ) - _Offsets.y ) ) + _ZBufferParams.w ) ) );
		}
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;1772.495;806.5004;1.168702;False;False
...
Node;AmplifyShaderEditor.Vector3Node;56;-1524.73,-116.9666;Inherit;False;Property;_Offsets;Offsets;7;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;42;-1641.313,45.19394;Inherit;True;Global;_CameraDepthTexture;_CameraDepthTexture;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;55;-1337.737,107.4241;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;57;-1127.371,123.786;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ZBufferParams;51;-1329.556,276.3015;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;52;-974.2707,126.7078;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;53;-830.5204,126.7078;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;49;-384.0766,80.46076;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;46;-489.3412,-116.2556;Inherit;False;#ifdef UNITY_UV_STARTS_AT_TOP${$}$#else${$	input.y = 1 - input.y@$}$#endif$return input@;2;Create;1;True;input;FLOAT2;0,0;In;;Inherit;False;My Custom Expression;True;False;0;;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;38;-272.6904,161.7245;Inherit;True;Property;_MainTex;Smoke Texture;6;0;Create;False;0;0;0;False;0;False;-1;None;89d27d66d73c7234b96121240ea914ed;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;17;-148,2;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-232,355;Inherit;False;Property;_SmokeIntensity;Smoke Intensity;3;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2EE174B142D751B44C6A568EB8B7D10DABE64A1A