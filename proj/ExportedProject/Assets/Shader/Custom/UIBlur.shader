	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				...
				float4 staticSwitch23 = tex2D( _BloomPrePassTexture, ase_screenPosNorm.xy );
			#else
...
/*ASEBEGIN
Version=18935
0;0;1536;795;1504.244;233.2741;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;21;-1247.244,338.2259;Inherit;False;Property;_AddColor;Add Color;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.099654,0.1411765,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=3743CA9D1F84E4F93BA75D5F5FFBA54AC02EDF56