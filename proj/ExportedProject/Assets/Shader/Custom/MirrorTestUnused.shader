...
Shader "Urki/MirrorTest"
{
	...
	SubShader
	{
		...
		float4 GammaCorrection37( float4 input, float GammaValue )
		{
			float4 clr = input;
			clr = log2(clr);
			clr *= GammaValue;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 input37 = ( tex2D( _BloomPrePassTexture, ase_grabScreenPosNorm.xy ) + ( _CustomFogColor * _CustomFogColorMultiplier ) );
			float GammaValue37 = _CustomFogGammaCorrection;
			float4 localGammaCorrection37 = GammaCorrection37( input37 , GammaValue37 );
			o.Emission = ( ( tex2DNode2 * temp_output_7_0 * _TintColor ) + ( clampResult26 * localGammaCorrection37 ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;0;1536;795;997.733;228.8232;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;27;-994.13,-90.18916;Inherit;False;Global;_CustomFogOffset;_CustomFogOffset;7;0;Create;True;0;0;0;False;0;False;0;1.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-826,487.5;Inherit;False;Global;_CustomFogColorMultiplier;_CustomFogColorMultiplier;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;29;-756,318.5;Inherit;False;Global;_CustomFogColor;_CustomFogColor;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;3;-587,115;Inherit;True;Global;_BloomPrePassTexture;_BloomPrePassTexture;3;0;Create;True;0;0;0;False;0;False;-1;None;;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-486,300.5;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-486.0589,395.6619;Inherit;False;Global;_CustomFogGammaCorrection;_CustomFogGammaCorrection;7;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;28;-238,117.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;37;-120.4073,104.6917;Inherit;False;float4 clr = input@$clr = log2(clr)@$clr *= GammaValue@$clr = exp2(clr)@$return clr@;4;Create;2;True;input;FLOAT4;0,0,0,0;In;;Inherit;False;True;GammaValue;FLOAT;0;In;;Inherit;False;Gamma Correction;True;False;0;;False;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;6;117,-5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;181,103;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;8;246,-67;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=32CFE4869EE80B353101D532EA99063431738D0F