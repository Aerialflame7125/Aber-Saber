...
Shader "Urki/FogLighting"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			o.Emission = ( ( ( tex2D( _BloomPrePassTexture, localMyCustomExpression80 ) + ( _CustomFogColor * _CustomFogColorMultiplier ) ) * clampResult15 ) + ( temp_output_19_0 * ( _Color + staticSwitch105 ) ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;1736.572;727.584;1.3;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-1645.702,-244.395;Inherit;False;Global;_CustomFogAttenuation;_CustomFogAttenuation;7;0;Create;True;0;0;0;False;0;False;0;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-1660.702,-103.3949;Inherit;False;Global;_CustomFogOffset;_CustomFogOffset;7;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-1572.354,-175.576;Inherit;False;Property;_FogOffset;Fog Offset;3;0;Create;True;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;56;-1654.702,49.60501;Inherit;False;Property;_FresnelVector;FresnelVector;6;0;Create;True;0;0;0;False;0;False;0,0,0;1,5,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.GrabScreenPosition;78;-970.9,-12.9963;Inherit;False;0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;53;-1227.702,-108.395;Inherit;False;Property;_FogClamp;FogClamp;5;0;Create;True;0;0;0;False;0;False;0,0;0,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;12;-1168.355,-219.576;Inherit;False;Property;_FogScale;Fog Scale;4;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;80;-756.074,-77.82007;Inherit;False;#ifdef UNITY_UV_STARTS_AT_TOP${$}$#else${$	input.y = 1 - input.y@$}$#endif$return input@;2;Create;1;True;input;FLOAT2;0,0;In;;Inherit;False;My Custom Expression;True;False;0;;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector4Node;62;-604.3997,-491.4962;Inherit;False;Global;_CustomFogColor;_CustomFogColor;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;9;-383.5,32;Inherit;False;Property;_Color;Color;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=61E5EF72BEB8D6BD4619E684C5CCC30136006338