...
Shader "Urki/ScreenDisplacementSimpleTransparent"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( (( _EnableFog )?( clampResult13 ):( 0.0 )) * tex2D( _BloomPrePassTexture, localMyCustomExpression25 ) ) + ( ( ( _CullMode * 0.0 ) + ( _TintColor * float4( 0.1,0.1,0.1,0.1019608 ) ) + _AddColor ) * ( 1.0 - (( _EnableFog )?( clampResult13 ):( 0.0 )) ) ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;1980.199;1071.92;1.366632;False;False
Node;AmplifyShaderEditor.SurfaceDepthNode;16;-1402.656,-379.6341;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1421.216,-298.4305;Inherit;False;Global;_CustomFogAttenuation;_CustomFogAttenuation;7;0;Create;True;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-1436.216,-157.4304;Inherit;False;Global;_CustomFogOffset;_CustomFogOffset;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;18,-233.5;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;30;382,-122.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=147BBEDBB3F2CDEB734CA1AE0A24524AF0150042