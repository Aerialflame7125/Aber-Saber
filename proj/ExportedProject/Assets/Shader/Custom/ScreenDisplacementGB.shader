...
Shader "Urki/ScreenDisplacementGB"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			float4 DistortedFogUV91 = ( ase_screenPosNorm + float4( ( UnpackNormal( tex2D( _DisplacementTexture, uv_DisplacementTexture ) ) * ( staticSwitch131 * ( 1.0 - (( _EnableFog )?( clampResult33 ):( 0.0 )) ) ) * tex2DNode7.a * float3( float2( 1,1 ) ,  0.0 ) ) , 0.0 ) );
			...
			o.Emission = ( ( tex2D( _BloomPrePassTexture, localMyCustomExpression74 ) * (( _EnableFog )?( clampResult33 ):( 0.0 )) ) + ( ( ( TransparentFog75 * temp_output_14_0 ) + ( ( ( DistortedFog87 * _TintColor ) + _AddColor ) * temp_output_10_0 ) + ( 0.0 * _CullMode ) ) * temp_output_46_0 ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;0;2560;1379;563.1342;1012.798;1.008698;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-1291.272,-566.4888;Inherit;False;Global;_CustomFogAttenuation;_CustomFogAttenuation;7;0;Create;True;0;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1567.094,219.8131;Inherit;False;Property;_DisplacementIntensity;Displacement Intensity;0;0;Create;True;0;0;0;False;0;False;0;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;21;-1243.345,-25.81232;Inherit;True;Property;_DisplacementTexture;DisplacementTexture;2;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;35;-580,132.5;Inherit;False;Property;_TintColor;Tint Color;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.5019608,0.5019608,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;39;-327,62.5;Inherit;False;Property;_AddColor;Add Color;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.125,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;135;-382.6825,1129.676;Inherit;False;Property;_CutoutTexScale;Cutout Texture Scale;11;0;Create;False;0;0;0;False;0;False;0;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;82;-1176.42,-1006.621;Inherit;True;Global;_BloomPrePassTexture;_BloomPrePassTexture;10;0;Create;True;0;0;0;False;0;False;None;;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.CustomExpressionNode;74;-477.0991,-400.6768;Inherit;False;#ifdef UNITY_UV_STARTS_AT_TOP${$}$#else${$	input.y = 1 - input.y@$}$#endif$return input@;2;Create;1;True;input;FLOAT2;0,0;In;;Inherit;False;My Custom Expression;True;False;0;;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;16;572.4486,-259.3241;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;820.8806,-305.0161;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;47;987.3613,-250.8968;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=943024F2A30BF352D77A668D9F1A89C0B80FCB46