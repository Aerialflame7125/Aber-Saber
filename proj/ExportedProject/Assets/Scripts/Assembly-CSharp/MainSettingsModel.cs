...
public class MainSettingsModel : ScriptableObject
{
	...
	private class Config
	{
        ...
        public int enableFPSCounter;

        public int enableDemoText;

        public int enableLebronify;

        public int enableDebris;

		public int enableAerialLogText;

        public int enableRctts;
	...
	public float pauseButtonPressDuration
	{
		get
		{
			return (float)config.pauseButtonPressDurationLevel * 0.75f;
		}
	}
    ...
    public bool enableFPSCounter
    {
        get
        {
            return config.enableFPSCounter == 1;
        }
        set
        {
            config.enableFPSCounter = (value ? 1 : 0);
        }
    }

    public bool enableDemoText
    {
        get
        {
            return config.enableDemoText == 1;
        }
        set
        {
            config.enableDemoText = (value ? 1 : 0);
        }
    }

    public bool enableLebronify
    {
        get
        {
            return config.enableLebronify == 1;
        }
        set
        {
            config.enableLebronify = (value ? 1 : 0);
        }
    }
    ...
    public bool enableDebris
    {
        get
        {
            return config.enableDebris == 1;
        }
        set
        {
            config.enableDebris = (value ? 1 : 0);
        }
    }
	
	public bool enableAerialLogText
    {
        get
        {
            return config.enableAerialLogText == 1;
        }
        set
        {
            config.enableAerialLogText = (value ? 1 : 0);
        }
    }

    public bool enableRctts
    {
        get
        {
            return config.enableRctts == 1;
        }
        set
        {
            config.enableRctts = (value ? 1 : 0);
        }
    }
