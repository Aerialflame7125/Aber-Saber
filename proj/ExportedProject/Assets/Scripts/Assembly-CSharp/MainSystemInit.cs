...
public class MainSystemInit : MonoBehaviour
{
    ...
    [SerializeField]
    private ScriptInitSetup _scriptInitSetup;
    ...
    private void Awake()
    {
        ...
        try
        {
            ...
            try
            {
                IsSteamInitialized = SteamClient.Init(4000);
                if (IsSteamInitialized)
                {
                    // Steam is initialized, you can now use other Steam features
                ...
                else
                {
                    ...
                    UnityEngine.Debug.LogError("Failed to initialize Steamworks");
                }
            }
            ...
            catch (System.Exception e)
            {
                ...
                UnityEngine.Debug.LogError($"Exception during Steam initialization: {e.Message}");
            }
            */
            Entitlements.IsUserEntitledToApplication().OnComplete(delegate (Message message)
            {
                if (message.IsError)
                {
                    ...
                    Debug.LogError("Oculus user entitlement check failed. You are NOT entitled to use this app. But I don't have a quit function loll");
                }
                TransitionToMenu();
            });
        }
    ...
    private void TransitionToMenu()
    {
        ...
        SceneManager.LoadScene("HealthAndSafetyWarning", LoadSceneMode.Single);
        _scriptInitSetup.Init();
    }
}
