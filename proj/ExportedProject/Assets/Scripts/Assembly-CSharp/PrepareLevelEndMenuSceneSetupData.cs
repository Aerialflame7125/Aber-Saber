...
public class PrepareLevelEndMenuSceneSetupData : MonoBehaviour
{
	...
	public LevelCompletionResults FillLevelCompletionResults(LevelCompletionResults.LevelEndStateType levelEndStateType)
	{
		...
		int finalScore = _scoreController.prevFrameScore;
		string replayPath = "Replay.bsor"; // Your desired path

		// --- CORRECTED LINE ---
		if (VRControllersRecorder.Instance != null)
		{
			VRControllersRecorder.Instance.StopAndSaveReplay(replayPath, finalScore, songDuration);
		}
