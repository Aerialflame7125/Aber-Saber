...
public class TubeBloomPrePassLight : BloomPrePassLight
{
	...
	[SerializeField]
	private Color _color = new Color(0.0024f, 0.5271f, 1f, 0.25f); // Your earlier working color
	...
	{
		if (_color.a == 0 && _color.r == 0 && _color.g == 0 && _color.b == 0)
		{
			_color = new Color(0.0024f, 0.5271f, 1f, 0.25f); // fallback to visible default
		}
	...
	public override void FillMeshData(int lightNum, Vector3[] vertices, Color32[] colors32, Vector2[] uv2, Vector2[] uv3, Matrix4x4 viewMatrix, Matrix4x4 projectionMatrix, float lineWidth)
	{
		...
		int num8 = lightNum * 4;
		vertices[num8] = vector11 - vector14;
		vertices[num8 + 1] = vector11 + vector14;
		vertices[num8 + 2] = vector12 + vector14;
		vertices[num8 + 3] = vector12 - vector14;
