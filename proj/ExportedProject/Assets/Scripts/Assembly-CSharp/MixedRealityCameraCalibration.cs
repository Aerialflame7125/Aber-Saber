...
public class MixedRealityCameraCalibration : MonoBehaviour
{
	...
	public void SetState(STATE value)
	{
		...
		case STATE.CAMERA:
			...
			break;
		case STATE.TOP_LEFT:
			topLeftScreen.gameObject.SetActive(true);
			break;
		case STATE.TOP_RIGHT:
			topRightScreen.gameObject.SetActive(true);
			break;
		case STATE.BOTTOM_LEFT:
			bottomLeftScreen.gameObject.SetActive(true);
			break;
		case STATE.BOTTOM_RIGHT:
			bottomRightScreen.gameObject.SetActive(true);
			break;
	...
	public void HideScreens()
	{
		...
		topLeftScreen.gameObject.SetActive(false);
		topRightScreen.gameObject.SetActive(false);
		bottomLeftScreen.gameObject.SetActive(false);
		bottomRightScreen.gameObject.SetActive(false);
