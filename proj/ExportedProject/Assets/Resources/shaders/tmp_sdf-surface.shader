	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoord6.y = abs(tmp1.x) * tmp0.w + tmp1.w;
                tmp0.w = v.texcoord1.y <= 0.0;
                tmp0.w = tmp0.w ? 1.0 : 0.0;
                tmp1.x = _WeightBold - _WeightNormal;
                tmp0.w = tmp0.w * tmp1.x + _WeightNormal;
                tmp0.w = tmp0.w * 0.25 + _FaceDilate;
                tmp0.w = tmp0.w * _ScaleRatioA;
                ...
                tmp0.xyz = tmp2.yyy * _EnvMatrix._m01_m11_m21;
                tmp0.xyz = _EnvMatrix._m00_m10_m20 * tmp2.xxx + tmp0.xyz;
                o.texcoord7.xyz = _EnvMatrix._m02_m12_m22 * tmp2.zzz + tmp0.xyz;
                return o;
			}
			// Keywords: POINT
			fout frag(v2f inp)
