...
public class PoolableStaticMemoryPool<TValue> : StaticMemoryPool<TValue> where TValue : class, IPoolable, new()
{
	public PoolableStaticMemoryPool()
		: base((Action<TValue>)OnSpawned, (Action<TValue>)OnDespawned)
	{
	}
...
{
	public PoolableStaticMemoryPool()
		: base((Action<TParam1, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
	{
	}
...
{
	public PoolableStaticMemoryPool()
		: base((Action<TParam1, TParam2, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
	{
	}
...
{
	public PoolableStaticMemoryPool()
		: base((Action<TParam1, TParam2, TParam3, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
	{
	}
...
{
	public PoolableStaticMemoryPool()
		: base((Action<TParam1, TParam2, TParam3, TParam4, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
	{
	}
...
{
	public PoolableStaticMemoryPool()
		: base((Action<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
	{
	}
...
{
	public PoolableStaticMemoryPool()
		: base((Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
	{
	}
...
{
	public PoolableStaticMemoryPool()
		: base((Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
	{
	}
