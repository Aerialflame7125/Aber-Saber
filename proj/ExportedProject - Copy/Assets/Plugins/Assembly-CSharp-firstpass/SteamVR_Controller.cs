...
public class SteamVR_Controller
{
	...
	{
		int result = -1;
		SteamVR_Utils.RigidTransform rigidTransform = (((uint)relativeTo >= 64u) ? SteamVR_Utils.RigidTransform.identity : Input(relativeTo).transform.GetInverse());
		CVRSystem system = OpenVR.System;
		if (system == null)
		{
			return result;
