	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                tmp2.y = dot(tmp0.xyz, unity_WorldToObject._m00_m10_m20);
                tmp2.z = dot(tmp0.xyz, unity_WorldToObject._m01_m11_m21);
                tmp2.x = dot(tmp0.xyz, unity_WorldToObject._m02_m12_m22);
                ...
                o.texcoord5.y = abs(tmp2.w) * tmp0.w + tmp1.w;
                ...
                o.color = v.color;
                tmp0.xyz = tmp2.yyy * _EnvMatrix._m01_m11_m21;
                tmp0.xyz = _EnvMatrix._m00_m10_m20 * tmp2.xxx + tmp0.xyz;
                o.texcoord6.xyz = _EnvMatrix._m02_m12_m22 * tmp2.zzz + tmp0.xyz;
                return o;
			}
			// Keywords: DIRECTIONAL
			fout frag(v2f inp)
			{
                ...
                if (tmp1.x) {
                    ...
                    tmp1.yzw = inp.texcoord3.www * unity_ProbeVolumeWorldToObject._m01_m11_m21;
                    tmp1.yzw = unity_ProbeVolumeWorldToObject._m00_m10_m20 * inp.texcoord2.www + tmp1.yzw;
                    tmp1.yzw = unity_ProbeVolumeWorldToObject._m02_m12_m22 * inp.texcoord4.www + tmp1.yzw;
                    ...
                    tmp1.xyz = tmp1.xxx ? tmp1.yzw : tmp2.yzw;
