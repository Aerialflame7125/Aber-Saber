...
public class ArcadeLevelSelectionFlowCoordinator : FlowCoordinator
{
	...
	public void Present()
	{
		...
		_levelSelectionNavigationController.InitWithoutGameplayModeIndicator(false);
		_levelListViewController.Init(_levelCollection.levels, true);
	...
	{
		_arcadeInitialViewController.PresentModalViewController(_levelSelectionNavigationController, null, true);
		_levelSelectionNavigationController.PushViewController(_levelListViewController, true);
	}
	...
	private void HandleLevelListViewControllerDidSelectLevel(StandardLevelListViewController viewController, IStandardLevel level)
	{
		...
		{
			_levelDifficultyViewController.Init(level.difficultyBeatmaps, true);
