...
public class CustomLevelSelectionNavigationController : VRUINavigationController
{
	[SerializeField]
	...
	public event Action<CustomLevelSelectionNavigationController> didFinishEvent;
