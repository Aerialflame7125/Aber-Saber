...
public class BeatmapObjectSpawnController : MonoBehaviour
{
	...
	private float HighestJumpPosYForLineLayer(NoteLineLayer lineLayer)
	{
		...
		case NoteLineLayer.Base:
			return _baseLinesHighestJumpPosY + _globalYJumpOffset;
		case NoteLineLayer.Upper:
			return _upperLinesHighestJumpPosY + _globalYJumpOffset;
		default:
			return _topLinesHighestJumpPosY + _globalYJumpOffset;
		}
	}
	...
	private float LineYPosForLineLayer(NoteLineLayer lineLayer)
	{
		...
		{
		case NoteLineLayer.Base:
			return _baseLinesYPos;
		case NoteLineLayer.Upper:
			return _upperLinesYPos;
		default:
			return _topLinesYPos;
		}
	}
