...
public class ScoreController : MonoBehaviour
{
	...
	public int multiplierWithFever
	{
		get
		{
			return _multiplier * ((!_feverIsActive) ? 1 : 2);
		}
	}
	...
	public float feverModeDrainProgress
	{
		get
		{
			return Mathf.Clamp01((_songTime.value - _feverStartTime) / _feverModeDuration);
		}
	}
	...
	public float feverModeChargeProgress
	{
		get
		{
			return (float)_feverCombo / (float)_feverModeRequiredCombo;
		}
	}
