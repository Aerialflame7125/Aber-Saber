...
internal sealed class OdbcStatementHandle : OdbcHandle
{
	...
	internal ODBC32.RetCode ColumnAttribute(int columnNumber, short fieldIdentifier, CNativeBuffer characterAttribute, out short stringLength, out SQLLEN numericAttribute)
	{
		...
		ODBC32.RetCode retCode = UnsafeNativeMethods.SQLColAttributeW(this, checked((short)columnNumber), fieldIdentifier, characterAttribute, characterAttribute.ShortLength, out stringLength, out NumericAttribute);
	...
	{
		IntPtr RowCount;
		ODBC32.RetCode retCode = UnsafeNativeMethods.SQLRowCount(this, out RowCount);
