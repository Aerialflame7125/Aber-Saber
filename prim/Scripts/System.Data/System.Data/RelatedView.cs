...
internal sealed class RelatedView : DataView, IFilter
{
	...
	public override bool Equals(DataView dv)
	{
		...
		if (_filterValues != null)
		{
			if (CompareArray(_childKey.ColumnsReference, relatedView._childKey.ColumnsReference))
			{
		...
		if (CompareArray(_childKey.ColumnsReference, relatedView._childKey.ColumnsReference) && CompareArray(_parentKey.Value.ColumnsReference, _parentKey.Value.ColumnsReference))
		{
