...
public class GameNoteController : NoteController
{
	...
	public float minBladeSpeedForCut => _minBladeSpeedForCut;
	...
	{
		HandleCut(saber, cutPoint, orientation, cutDirVec, allowBadCut: false);
	}

	private void HandleSmallWasCutBySaberEvent(Saber saber, Vector3 cutPoint, Quaternion orientation, Vector3 cutDirVec)
	{
		HandleCut(saber, cutPoint, orientation, cutDirVec, allowBadCut: true);
	}
	...
	private void HandleCut(Saber saber, Vector3 cutPoint, Quaternion orientation, Vector3 cutDirVec, bool allowBadCut)
	{
		...
		GetBasicCutInfo(saber, cutDirVec, _minBladeSpeedForCut, out var directionOK, out var speedOK, out var saberTypeOK, out var cutDirDeviation);
		...
		NoteCutInfo noteCutInfo = new NoteCutInfo(speedOK, directionOK, saberTypeOK, wasCutTooSoon: false, saber.bladeSpeed, cutDirVec, saber.saberType, swingRating, timeDeviation, cutDirDeviation, cutPoint, vector, afterCutSwingRatingCounter, cutDistanceToCenter);
