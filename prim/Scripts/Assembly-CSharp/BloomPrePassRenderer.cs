	...
	private void PrepareLightsMeshRendering(int numberOfLights)
	{
		...
		if (!_mesh || _mesh.vertexCount != numberOfLights * 4)
		{
			...
			for (int i = 0; i < numberOfLights; i++)
			{
				...
				array[i * 6 + 4] = i * 4 + 3;
				array[i * 6 + 5] = i * 4;
				ref Vector2 reference = ref array2[i * 4];
				reference = new Vector2(0f, 0f);
				ref Vector2 reference2 = ref array2[i * 4 + 1];
				reference2 = new Vector2(1f, 0f);
				ref Vector2 reference3 = ref array2[i * 4 + 2];
				reference3 = new Vector2(1f, 1f);
				ref Vector2 reference4 = ref array2[i * 4 + 3];
