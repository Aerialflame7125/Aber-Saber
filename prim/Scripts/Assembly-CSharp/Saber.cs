...
public class Saber : MonoBehaviour
{
	...
	public SaberType saberType => _saberType.saberType;

	public Vector3 saberBladeTopPos => _topPos.position;

	public Vector3 saberBladeBottomPos => _bottomPos.position;

	public Transform saberBladeTopPosTransform => _topPos;

	public Transform saberBladeBottomPosTransform => _bottomPos;

	public Vector3 handlePos => _handlePos.position;
	...
	private void Update()
	{
		...
		if (_prevValuesAreValid && !disableCutting)
		{
			...
			if (GeometryTools.ThreePointsToBox(position, position2, (lastAddedTimeAndPos.bottomPos + lastAddedTimeAndPos.topPos) * 0.5f, out var center, out var halfSize, out var orientation))
			{
