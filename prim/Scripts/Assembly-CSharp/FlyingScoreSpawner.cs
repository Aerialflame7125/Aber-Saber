...
public class FlyingScoreSpawner : MonoBehaviour
{
	...
	public void SpawnFlyingScore(NoteCutInfo noteCutInfo, int noteLineIndex, int multiplier, Vector3 pos, Color color, SaberAfterCutSwingRatingCounter saberAfterCutSwingRatingCounter)
	{
		...
		flyingScoreTextEffect.InitAndPresent(noteCutInfo, multiplier, targetPos, color, saberAfterCutSwingRatingCounter);
	}
}
