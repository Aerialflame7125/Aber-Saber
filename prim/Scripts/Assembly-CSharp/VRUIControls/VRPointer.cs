...
public class VRPointer : MonoBehaviour
{
	...
	private EventSystem eventSystem => _eventSystem ?? (_eventSystem = GetComponent<EventSystem>());
	...
	private void CreateLaserPointerAndLaserHit()
	{
		...
		{
			_laserPointerTransform = Object.Instantiate(_laserPointerPrefab, _vrController.transform, worldPositionStays: false);
		...
		if (_laserHitTransform == null && _laserHitPrefab != null)
		{
			...
			_laserHitTransform.gameObject.SetActive(value: false);
			_laserHitTransform.SetParent(base.transform, worldPositionStays: false);
		}
	}
	...
	private void RefreshLaserPointerAndLaserHit(PointerEventData pointerData)
	{
		if (pointerData.pointerCurrentRaycast.gameObject != null)
		{
			...
			{
				_laserHitTransform.gameObject.SetActive(value: true);
	...
	private void DestroyLaserAndHit()
	{
		if (_laserPointerTransform != null)
		{
			_laserPointerTransform.gameObject.SetActive(value: false);
