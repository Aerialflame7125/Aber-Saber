...
public class NoteCutEffectSpawner : MonoBehaviour
{
	...
	private void SpawnNoteCutEffect(Vector3 pos, NoteController noteController, NoteCutInfo noteCutInfo)
	{
		if (noteCutInfo.allIsOK)
		{
			...
			int multiplierWithFever = _scoreController.multiplierWithFever;
			_flyingScoreSpawner.SpawnFlyingScore(noteCutInfo, noteData.lineIndex, multiplierWithFever, pos, new Color(0f, 0.5f, 1f), noteCutInfo.afterCutSwingRatingCounter);
