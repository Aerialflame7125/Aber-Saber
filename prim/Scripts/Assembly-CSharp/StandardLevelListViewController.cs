...
public class StandardLevelListViewController : VRUIViewController
{
	...
	public IStandardLevel selectedLevel => _selectedLevel;
	...
	protected override void RebuildHierarchy(object hierarchyRebuildData)
	{
		if (hierarchyRebuildData is HierarchyRebuildData hierarchyRebuildData2)
		{
			...
			HandleLevelSelectionDidChange(_levelListTableView.RowNumberForLevelID(hierarchyRebuildData2.levelID), crossfadeAudio: false);
		}
	}
	...
	private void HandleLevelSelectionDidChange(int row, bool crossfadeAudio)
	{
		...
		if (this.didSelectLevelEvent != null)
		{
			this.didSelectLevelEvent(this, _selectedLevel);
		}
	}

	private void HandleLevelListTableViewDidSelectRow(StandardLevelListTableView tableView, int row)
	{
		HandleLevelSelectionDidChange(row, crossfadeAudio: true);
	}
