...
public class MainSettingsMenuViewController : VRUIViewController
{
	...
	public SettingsSubMenuInfo selectedSubMenuInfo => _selectedSubMenuInfo;
	...
	public SimpleSettingsController[] GetSimpleSettingsControllers()
	{
		...
		{
			list.AddRange(settingsSubMenuInfo.controller.GetComponentsInChildren<SimpleSettingsController>(includeInactive: false));
		}
		return list.ToArray();
	}
	...
	protected override void DidActivate(bool firstActivation, ActivationType activationType)
	{
		if (activationType == ActivationType.AddedToHierarchy)
		{
			...
			_mainSettingsTableView.SelectRow(0, callbackTable: true);
		}
	}

	protected override void RebuildHierarchy(object hierarchyRebuildData)
	{
		if (hierarchyRebuildData is HierarchyRebuildData { settingsSubMenuInfo: not null } hierarchyRebuildData2)
		{
			int mainSettingsIndex = GetMainSettingsIndex(hierarchyRebuildData2.settingsSubMenuInfo);
			_mainSettingsTableView.SelectRow(mainSettingsIndex, callbackTable: true);
		}
	}
