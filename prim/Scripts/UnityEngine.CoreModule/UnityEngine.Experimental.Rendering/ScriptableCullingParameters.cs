...
public struct ScriptableCullingParameters
{
	...
	public unsafe float GetLayerCullDistance(int layerIndex)
	{
		...
		fixed (float* layerFarCullDistances = &m_LayerFarCullDistances.FixedElementField)
		{
			return System.Runtime.CompilerServices.Unsafe.Add(ref *layerFarCullDistances, layerIndex);
		}
	}
	...
	public unsafe void SetLayerCullDistance(int layerIndex, float distance)
	{
		...
		fixed (float* layerFarCullDistances = &m_LayerFarCullDistances.FixedElementField)
		{
			System.Runtime.CompilerServices.Unsafe.Add(ref *layerFarCullDistances, layerIndex) = distance;
		}
	}
	...
	public unsafe Plane GetCullingPlane(int index)
	{
		...
		fixed (float* cullingPlanes = &m_CullingPlanes.FixedElementField)
		{
