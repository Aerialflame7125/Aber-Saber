...
public class NetworkAnimator : NetworkBehaviour
{
	...
	internal static void OnAnimationServerMessage(NetworkMessage netMsg)
	{
		...
		if (LogFilter.logDev)
		{
			Debug.Log(string.Concat("OnAnimationMessage for netId=", s_AnimationMessage.netId, " conn=", netMsg.conn));
		}
	...
	internal static void OnAnimationParametersServerMessage(NetworkMessage netMsg)
	{
		...
		if (LogFilter.logDev)
		{
			Debug.Log(string.Concat("OnAnimationParametersMessage for netId=", s_AnimationParametersMessage.netId, " conn=", netMsg.conn));
		}
	...
	internal static void OnAnimationTriggerServerMessage(NetworkMessage netMsg)
	{
		...
		if (LogFilter.logDev)
		{
			Debug.Log(string.Concat("OnAnimationTriggerMessage for netId=", s_AnimationTriggerMessage.netId, " conn=", netMsg.conn));
		}
