...
internal class ContentListener : nsIURIContentListener
{
	...
	{
		if ((object)Events[WebBrowser.NavigationRequestedEvent] == null && owner.Navigation != null)
		{
			((nsIWebBrowser)owner.navigation.navigation).setParentURIContentListener(this);
		}
	...
	{
		NavigationRequestedEventHandler navigationRequestedEventHandler = (NavigationRequestedEventHandler)Events[WebBrowser.NavigationRequestedEvent];
