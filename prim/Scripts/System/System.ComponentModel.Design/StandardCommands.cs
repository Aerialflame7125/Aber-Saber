...
public class StandardCommands
{
	...
	public static readonly CommandID ViewCode = new CommandID(standardCommandSet, 333);
	...
	public static readonly CommandID DocumentOutline = new CommandID(standardCommandSet, 239);
	...
	public static readonly CommandID Cut = new CommandID(standardCommandSet, 16);
	...
	public static readonly CommandID Delete = new CommandID(standardCommandSet, 17);
	...
	public static readonly CommandID HorizSpaceConcatenate = new CommandID(standardCommandSet, 21);
	...
	public static readonly CommandID HorizSpaceDecrease = new CommandID(standardCommandSet, 22);
	...
	public static readonly CommandID HorizSpaceIncrease = new CommandID(standardCommandSet, 23);
	...
	public static readonly CommandID HorizSpaceMakeEqual = new CommandID(standardCommandSet, 24);

	/// <summary>Gets the <see cref="T:System.ComponentModel.Design.CommandID" /> for the Paste command. This field is read-only.</summary>
	public static readonly CommandID Paste = new CommandID(standardCommandSet, 26);
	...
	public static readonly CommandID Properties = new CommandID(standardCommandSet, 28);

	/// <summary>Gets the <see cref="T:System.ComponentModel.Design.CommandID" /> for the Redo command. This field is read-only.</summary>
	public static readonly CommandID Redo = new CommandID(standardCommandSet, 29);
	...
	public static readonly CommandID SelectAll = new CommandID(standardCommandSet, 31);
	...
	public static readonly CommandID SendBackward = new CommandID(standardCommandSet, 32);
	...
	public static readonly CommandID SendToBack = new CommandID(standardCommandSet, 33);
	...
	public static readonly CommandID SizeToControl = new CommandID(standardCommandSet, 35);
	...
	public static readonly CommandID SizeToControlHeight = new CommandID(standardCommandSet, 36);
	...
	public static readonly CommandID SizeToControlWidth = new CommandID(standardCommandSet, 37);
	...
	public static readonly CommandID SizeToFit = new CommandID(standardCommandSet, 38);
	...
	public static readonly CommandID SizeToGrid = new CommandID(standardCommandSet, 39);
	...
	public static readonly CommandID TabOrder = new CommandID(standardCommandSet, 41);

	/// <summary>Gets the <see cref="T:System.ComponentModel.Design.CommandID" /> for the Undo command. This field is read-only.</summary>
	public static readonly CommandID Undo = new CommandID(standardCommandSet, 43);
	...
	public static readonly CommandID MultiLevelUndo = new CommandID(standardCommandSet, 44);
	...
	public static readonly CommandID Ungroup = new CommandID(standardCommandSet, 45);
	...
	public static readonly CommandID VertSpaceConcatenate = new CommandID(standardCommandSet, 46);
	...
	public static readonly CommandID VertSpaceDecrease = new CommandID(standardCommandSet, 47);
	...
	public static readonly CommandID VertSpaceIncrease = new CommandID(standardCommandSet, 48);
	...
	public static readonly CommandID VertSpaceMakeEqual = new CommandID(standardCommandSet, 49);
	...
	public static readonly CommandID ShowGrid = new CommandID(standardCommandSet, 103);
	...
	public static readonly CommandID ViewGrid = new CommandID(standardCommandSet, 125);
	...
	public static readonly CommandID PropertiesWindow = new CommandID(standardCommandSet, 235);
	...
	public static readonly CommandID LockControls = new CommandID(standardCommandSet, 369);
	...
	public static readonly CommandID F1Help = new CommandID(standardCommandSet, 377);
	...
	public static readonly CommandID ArrangeIcons = new CommandID(ndpCommandSet, 12298);
	...
	public static readonly CommandID LineupIcons = new CommandID(ndpCommandSet, 12299);
	...
	public static readonly CommandID ShowLargeIcons = new CommandID(ndpCommandSet, 12300);

	/// <summary>Gets the first of a set of verbs. This field is read-only.</summary>
	public static readonly CommandID VerbFirst = new CommandID(ndpCommandSet, 8192);

	/// <summary>Gets the last of a set of verbs. This field is read-only.</summary>
	public static readonly CommandID VerbLast = new CommandID(ndpCommandSet, 8448);
