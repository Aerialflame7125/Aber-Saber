...
public abstract class UriParser
{
	...
	{
		UriSyntaxFlags uriSyntaxFlags = (((flags & UriSyntaxFlags.UnEscapeDotsAndSlashes) != 0 && m_UpdatableFlagsUsed) ? ((m_Flags & ~UriSyntaxFlags.UnEscapeDotsAndSlashes) | m_UpdatableFlags) : m_Flags);
