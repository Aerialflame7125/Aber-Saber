	...
	private static void InitializeProviderRegistration()
	{
		lock (locker)
		{
			if (providerRegistration == null)
			{
				...
				Tuple<Guid, string> value = new Tuple<Guid, string>(AppleTlsId, "Mono.AppleTls.AppleTlsProvider");
				Tuple<Guid, string> value2 = new Tuple<Guid, string>(LegacyId, "Mono.Net.Security.LegacyTlsProvider");
				providerRegistration.Add("legacy", value2);
				...
				providerRegistration.Add("apple", value);
			}
		}
	}
