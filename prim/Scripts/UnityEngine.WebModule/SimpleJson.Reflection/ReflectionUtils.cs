...
internal class ReflectionUtils
{
	...
	public static bool IsTypeGenericeCollectionInterface(Type type)
	{
		...
		return (object)genericTypeDefinition == typeof(IList<>) || (object)genericTypeDefinition == typeof(ICollection<>) || (object)genericTypeDefinition == typeof(IEnumerable<>);
	}
	...
	{
		return type.IsGenericType && (object)type.GetGenericTypeDefinition() == typeof(Nullable<>);
	}
	...
	public static ConstructorDelegate GetConstructorByReflection(Type type, params Type[] argsType)
	{
		...
		return ((object)constructorInfo != null) ? GetConstructorByReflection(constructorInfo) : null;
	}
