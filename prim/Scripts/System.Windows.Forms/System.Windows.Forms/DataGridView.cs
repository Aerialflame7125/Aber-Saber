...
public class DataGridView : Control, IDisposable, IComponent, ISupportInitialize, IBindableComponent, IDropTarget
{
	private class ColumnSorter : IComparer
	{
		...
		public int Compare(object x, object y)
		{
			...
			if ((object)dataGridViewRow.Cells[column].ValueType == typeof(DateTime) && (object)dataGridViewRow2.Cells[column].ValueType == typeof(DateTime))
			{
	...
	protected override bool CanEnableIme
	{
		get
		{
			if (CurrentCell != null && (object)CurrentCell.EditType != null)
			{
				return true;
			}
			return false;
	...
	public virtual bool BeginEdit(bool selectAll)
	{
		...
		if ((object)editType == null && !(dataGridViewCell is IDataGridViewEditingCell))
		{
			return false;
		}
		...
		if ((object)editType != null)
		{
			Control control = EditingControlInternal;
			if (control == null || (object)control.GetType() != editType)
			{
				control = null;
			}
			if (control == null)
	...
	public virtual void Sort(DataGridViewColumn dataGridViewColumn, ListSortDirection direction)
	{
		...
		{
			if (DataManager.List is IBindingList { SupportsSorting: not false } bindingList)
			{
	...
	{
		if ((keyData & Keys.Control) == Keys.Control && (object)CurrentCell.EditType != null)
		{
