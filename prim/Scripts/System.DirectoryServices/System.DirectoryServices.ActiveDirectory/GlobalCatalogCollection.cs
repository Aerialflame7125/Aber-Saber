...
public class GlobalCatalogCollection : ReadOnlyCollectionBase
{
	...
	/// <returns>
	///   <see langword="true" /> if the <see cref="T:System.DirectoryServices.ActiveDirectory.GlobalCatalog" /> is in this collection; otherwise, <see langword="false" />.</returns>
	/// <exception cref="T:System.ArgumentNullException">
	///   <paramref name="globalCatalog" /> is <see langword="null" />.</exception>
	...
	/// <exception cref="T:System.ArgumentNullException">
	///   <paramref name="globalCatalogs" /> is <see langword="null" />.</exception>
