...
public sealed class EncoderExceptionFallbackBuffer : EncoderFallbackBuffer
{
	...
	{
		throw new EncoderFallbackException(Environment.GetResourceString("Unable to translate Unicode character \\\\u{0:X4} at index {1} to specified code page.", (int)charUnknown, index), charUnknown, index);
	}
	...
	public override bool Fallback(char charUnknownHigh, char charUnknownLow, int index)
	{
		...
		throw new EncoderFallbackException(Environment.GetResourceString("Unable to translate Unicode character \\\\u{0:X4} at index {1} to specified code page.", num, index), charUnknownHigh, charUnknownLow, index);
	}
